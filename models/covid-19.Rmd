...
models_plot <- tidy_antioquia %>% 
  ...
  scale_color_manual(values = colors, labels = c("Casos confirmados", 
                                                 ...
                                                 "Escenario ajustado (62%)")) +
  facet_zoom(xlim = c(ymd_hms("2020-04-08 00:00:00"), ymd_hms("2020-05-20 00:00:00")),
             ylim = c(0, 700), zoom.size = 0.7) +
  ...
  labs(title = "COVID-19: Antioquia - Modelo SIR - Población susceptible: 6.355.502",
       subtitle = "Fuente casos confirmados: Instituto Nacional de Salud (15/05/2020) - Fecha del modelo ajustado: (15/05/2020)",
       x = NULL,
       y = NULL,
       color = NULL) 
...
#Static
ggsave(plot = models_plot, "../plots/model_comparison_15-05-2020.png", width = 13, height = 6)
```
...
hosp_plot <- tidy_hosp %>%
  ...
  labs(title = "COVID-19: Población hospitalizada - EPS priorizadas - Modelo SIR - Población susceptible: 767.155",
       ...
       alpha = NULL) 
#Static
ggsave(plot = hosp_plot, "../plots/new_sc_hosp_comparison_13-05-2020.png", width = 12, height = 7)
...
#Static
ggsave(plot = uci_plot, "../plots/new_sc_uci_plot_13-05-2020.png", width = 12, height = 7)
```
