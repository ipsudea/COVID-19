...
national_cases <- cumulative %>%
  ...
  scale_y_continuous(breaks = seq(from = 0, to = 4000, by = 200)) +
  ...
  theme(legend.position = "bottom",
        ...
        legend.text = element_text(margin = margin(r = 10, unit = "pt"), size = 4),
        plot.title = element_text(hjust = 0.5, size = 8),
        plot.subtitle = element_text(size = 6)) +
  labs(title = "COVID-19: Evolución de casos acumulados por departamento",
       subtitle = "Fuente: Instituto Nacional de Salud (06/05/2020)",
       x = NULL,
       y = NULL,
       color = NULL)
...
#Static
ggsave(plot = national_cases, "../plots/dpts_06-05-2020.png", width = 5, height = 4)
```
...
uci_plot <- tidy_uci %>%
  ...
  # facet_zoom(xlim = c(ymd_hms("2020-04-05 00:00:00"), ymd_hms("2020-05-05 00:00:00")),
  #            ylim = c(0, 50), zoom.size = 0.5) +
  theme(axis.text.y = element_text(size = 5),
        title = element_text(size = 8, face = "bold", family = "sans"),
        legend.position = "bottom",
        legend.text = element_text(margin = margin(r = 2, unit = "pt"), size = 5),
        plot.title = element_text(hjust = 0.5),
...
#Static
ggsave(plot = uci_plot, "../plots/new_sc_uci_plot_06-05-2020.png", width = 5, height = 4)
```
